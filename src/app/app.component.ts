...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'SocialInfoPage', component: SocialInfoPage,icon :'md-desktop' },
      { title: 'BarcordScanner',component: BarcordScannerPage,icon:'aperture'},
      { title: 'Gmap', component: GMapPage,icon :'md-document' },
      { title: 'JsonMenu', component: JsonMenuPage,icon :'md-document' }
    ];
